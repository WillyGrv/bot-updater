...
SEL_USERNAME = 'input[name="email"]'
SEL_PASSWORD = 'input[name="password"]'
SEL_SUBMIT   = 'input[type="submit"][name="admin_login"]'
...
async def manual_login(page):
    ...
    try:
        ...
        # Mode dashboard (subprocess sans stdin interactif) :
...
async def save_session():
    ...
    async with async_playwright() as p:
        ...
        if not connected:
            ...
            name = None  # connexion manuelle : on ne sait pas qui s'est connecté
