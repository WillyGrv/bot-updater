...
BOTS = [
    {
        ...
        "scripts": [
            ...
            },
            {
                ...
                "description": "Pour chaque URL du CSV, vérifie la présence du bloc Solvimon (Documents comptables) et lit le statut des virements (Configuration).",
                "inputs":      ["input/data.csv (colonnes : id, url)", "session.json"],
    ...
    {
        "id":          "solvimon_portail",
        "name":        "Solvimon Portail",
        "subtitle":    "Automatisation Solvimon Desk",
        "description": "Scripts d'automatisation du portail Solvimon — connexion SSO via OKTA.",
        "color":       "info",
        "icon":        "bi-lightning-charge",
        "scripts": [
            {
                "file":        "login.py",
                "name":        "Tester la connexion SSO",
                "description": "Ouvre Chromium et vérifie que la connexion SSO / OKTA fonctionne. Pas nécessaire avant chaque script — la connexion est intégrée à chaque script.",
                "warning":     "Connexion manuelle via SSO / OKTA dans le navigateur.",
                "inputs":      [],
                "outputs":     [],
                "params":      [],
            },
            {
                "file":        "create_customers.py",
                "name":        "Créer les Customers",
                "description": "Connexion SSO en premier, puis pour chaque ligne du CSV ouvre le formulaire Add customer et crée l'organisation. Mode test → Save as draft. Mode prod → Save and activate.",
                "warning":     "Connexion manuelle via SSO / OKTA au démarrage.",
                "inputs":      ["input/customers_input.csv (colonnes : LEGAL NAME, REFERENCE, COUNTRY, STATUS, TIMEZONE, EMAIL ADDRESS, REGISTRATION NUMBER, TAX-ID, ADDRESS LINE1, ADDRESS LINE2, CITY, POSTAL CODE)"],
                "outputs":     ["results/results_customers_XXXXXX.csv"],
                "params":      [],
            },
        ],
        "session_check":   {"url": None},
        "results_globs":   ["results/results_customers_*.csv"],
        "editable_csvs":   [
            {"file": "input/customers_input.csv", "label": "Customers input.csv", "format": "LEGAL NAME, REFERENCE, COUNTRY, STATUS, TIMEZONE, EMAIL ADDRESS, REGISTRATION NUMBER, TAX-ID, ADDRESS LINE1, ADDRESS LINE2, CITY, POSTAL CODE", "color": "#06b6d4"},
        ],
        "test_mode_script": "create_customers.py",
    },
    {
        "id":          "portal_payplug",
